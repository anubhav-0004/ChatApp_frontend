  ...
  return (
    <>
      ...
      >
        ...
        />
        <span className="text-2xl pt-[0.2rem] font-semibold max-md:pl-[0.2rem] max-md:pt-3 bg-gradient-to-r from-[#ff9c3f] via-white to-[#27f527] bg-clip-text text-transparent max-md:animate-bounce">Sandesh</span>
