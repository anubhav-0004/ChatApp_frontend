...
const Chat = () => {
  ...
  return (
    ...
    >
      <div
        className="text-[#dfd3ad] w-full max-md:h-[92%] h-[90%] text-xl opacity-95 p-2 overflow-y-auto flex flex-col"
        style={{
      ...
      <form className="flex items-center relative rounded-t-sm justify-between border border-[#86869d] gap-x-3 px-2 py-1 bg-[#2d2d56] max-md:h-[8%] h-[10%]">
